    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <br>
                <div>
                    <p>Com nosso software de controle patrimonial simples, você pode simplificar a gestão dos ativos da sua empresa, economizando tempo e recursos preciosos. 
                        Com um cadastro descomplicado de novos bens e relatórios abrangentes, você terá todas as ferramentas necessárias para tomar decisões informadas e 
                        estratégicas para o seu negócio. Experimente hoje mesmo e descubra como podemos ajudá-lo a otimizar o controle do seu patrimônio!
                    </p>
                </div>
                ...
                <div class="mt-16">
                    ...
                    @if (Route::has('login'))
                    @auth
                        <a href="{{ route('cadastro') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                <div class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                <i class="fa-sharp fa-solid fa-book-open"></i>
                                </div>

                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">ENTRAR</h2>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Acesse o sistema para ver seus relatórios ou para realizar cadastros novos.
                                </p>
                            </div>
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Faça seu cadastro para ter acesso a todas as funcionalidades do sistema.
                                </p>
                            </div>
